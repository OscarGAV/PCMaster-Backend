...
public interface ITechnicalSupportQueryService
{
    ...
    /// <returns></returns>
    Task<IEnumerable<Model.Aggregates.TechnicalSupport>> Handle(GetAllTechnicalSupportQuery query);
    ...
    /// <param name="query"></param>
    /// <returns></returns>
    Task<IEnumerable<Model.Aggregates.TechnicalSupport>> Handle(GetTechnicalSupportBySupportTypeQuery query);
    ...
    /// <param name="query"></param>
    /// <returns></returns>
    Task<Model.Aggregates.TechnicalSupport> Handle(GetTechnicalSupportBySupportTypeAndTechnicianIdQuery query);
    ...
    /// <param name="query"></param>
    /// <returns></returns>
    Task<Model.Aggregates.TechnicalSupport> Handle(GetTechnicalSupportByIdQuery query);
}